...
/**
 * Less than the operator parser
 *
 * @param <T>
 */
@SuppressWarnings({"unchecked", "rawtypes"})
public class LessThanPredicate<T> extends PredictResolver {
    public LessThanPredicate(Class<T> clazz, SearchCriteria criteria) {
    ...
    public BooleanExpression getPredicate() throws Exception {
        ...
        return entityPath.getComparable(targetProp, valueType)
                .lt((Comparable) ConvertUtils.convert(valueStr, valueType));
    }
}
